...
global.Owner = {
  ...
  '62895429450605': { // put your number here
    name: 'Owner Andika Bot/Creator games-wabot',
  ...
  '628978161093': { // put your number here
    name: 'Dave',
    isDev: false, // if true this number will send if bot have bug and developer mode true
    isReport: true, // if true this number will send if user use command /report or /join
    isCreator: false // if true this number will send if user use command /owner or /creator
...
global.mods = ['62895429450605'] // Want some help?
...
// Sticker WM
global.packname = 'wa.me/628978161093'
global.author = 'Andika Bot Is The Best'
